...
const swapPlayer = () => {
    if (!playing) return;
    toggleCurrentPlayerBackground(document.querySelector(`.player-${currentPlayer}`));
...
const toggleCurrentPlayerBackground = (playerContainer) => {
    playerContainer.classList.toggle('current-player');
};
